...
evidence_chain_regex='TestTimelineEndpointSnapshotContract|TestTimelineIncidentEndpointSnapshotContract|TestTimelineDecisionEngineVersionContract|TestCorrelatedIncidentChainFromLoggingHelpers|TestIncidentTimelineQueryReturnsChronologicalEvents'
request_trace_regex='TestRequestTraceEndpointContract|TestRequestTraceEndpointIncludesDecisionEngineVersionContract|TestRequestTraceEndpointRejectsInvalidParams|TestProcessKillIdempotencyReplayAndConflict|TestDecisionReplayEndpointContract|TestDecisionReplayEndpointDetectsMismatch|TestDecisionReplayEndpointRejectsInvalidParams|TestDecisionReplayHealthEndpointContract|TestDecisionReplayHealthEndpointStrictMode|TestDecisionReplayHealthEndpointRejectsInvalidLimit|TestDecisionSignalBaselineEndpointContract|TestDecisionSignalBaselineEndpointStrictMode|TestDecisionSignalBaselineEndpointHardeningRequiresConsecutiveBreach|TestDecisionSignalBaselineEndpointHardeningInsufficientHistory|TestDecisionSignalBaselineEndpointRejectsInvalidLimit'
